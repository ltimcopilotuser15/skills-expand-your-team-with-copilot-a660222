...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'None' for activities with no difficulty)
    """
    ...
    if difficulty:
        if difficulty == "None":
            # "None" means activities with NO difficulty field (for all levels)
