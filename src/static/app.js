document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateShareUrls(activityName, description) {
    ...
    return {
      ...
      twitter: `https://twitter.com/intent/tweet?text=${text}&url=${pageUrl}&hashtags=${hashtags}`,
  ...
  function renderActivityCard(name, details) {
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-buttons">
        ...
        <a href="${shareUrls.linkedin}" target="_blank" rel="noopener noreferrer" class="share-btn linkedin-btn" title="Share on LinkedIn">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
